...
CREATE TABLE `sys_menu`  (
  ...
  `parent_id` int(10) NULL DEFAULT NULL COMMENT '父级编号',
  `parent_ids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '所有父级编号',
  `permission` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '角色标识',
  `icon` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '图标',
  `type` tinyint(3) NULL DEFAULT NULL COMMENT '菜单类型：0-菜单 1-按钮',
  `sort` int(10) NULL DEFAULT NULL COMMENT '排序',
  `del_flag` bit(1) NULL DEFAULT NULL COMMENT '删除状态：0-正常 1-删除',
  `create_by` int(10) NULL DEFAULT NULL COMMENT '创建人ID',
  `update_by` int(10) NULL DEFAULT NULL COMMENT '修改人ID',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_user`  (
  ...
  `enabled` bit(1) NULL DEFAULT NULL COMMENT '0-未启用，1-启用',
  `del_flag` bit(1) NULL DEFAULT NULL COMMENT '删除状态：0-正常 1-删除',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '{bcrypt}$2a$10$SYjcJB9OZ/kjauwD4n17GeKGY..YX3zPAvb/lSbBJoiZnRfXmzSFW', NULL, NULL, NULL, NULL, NULL, b'1', b'0', '2019-10-09 23:37:29', NULL, b'0');
